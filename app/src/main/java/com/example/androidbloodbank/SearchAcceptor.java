...
public class SearchAcceptor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_acceptor);
    ...
    public void ShowProfiles(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent1 = new Intent(getBaseContext(), AcceptorProfile.class);
    ...
    public void PopulateList(){
        ...
        if(AllProfiles.size() == 0 && !spinner.getSelectedItem().toString().equals("Select Group")){
            Toast.makeText(SearchAcceptor.this, "No Profile with this Blood group!", Toast.LENGTH_SHORT).show();
