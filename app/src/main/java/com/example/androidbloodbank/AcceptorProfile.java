...
public class AcceptorProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("Acceptors/"+ userID).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void CheckLocation(View v){
        ...
        if(statusOfGPS == true){
            ...
            Toast.makeText(AcceptorProfile.this, "GPS is off, turn it on please!", Toast.LENGTH_SHORT).show();
